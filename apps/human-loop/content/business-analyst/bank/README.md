...
- Fenwick house rule SC-08 (under 30 answers: "too few to tell"; two changes at once: "we can't tell which one helped") is a team rule, never a statistics claim. Pinecrest's 7-year records rule is "Pinecrest's policy", not law. No real laws or regulations.
