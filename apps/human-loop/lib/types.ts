...
export type LivePathwayId = "help-desk" | "cybersecurity" | "cloud-network" | "full-stack" | "business-analyst";
...
export const PATHWAYS: PathwayMeta[] = [
  ...
  },
  {
    ...
    agentName: "Piper",
    tagline: "Supervise an AI that ships fast and never reads the docs.",
    status: "live",
    idPrefix: "fs",
    agentSprite: "piper",
    firstShift: "Your first shift: Thursday afternoon on Fenwick's app team. One code freeze. One very fast robot.",
    practiceId: "fs-00-practice",
    storyId: "fs-01-thursday",
    storyTitle: "Thursday, 3:45 PM",
    pageTitle: "Full-Stack Development shift",
    pageDescription:
      "Supervise Piper, a fast AI coding agent. Read its plans, inspect the evidence, and stop the bad changes before they ship.",
  },
  {
    id: "business-analyst",
    ...
    idPrefix: "ba",
    agentSprite: "quill",
    firstShift: "Your first shift: Wednesday afternoon on Fenwick's analytics team. One big review. One very bold robot.",
    practiceId: "ba-00-practice",
    storyId: "ba-01-wednesday",
    storyTitle: "Wednesday, 1:47 PM",
    pageTitle: "Business Analyst shift",
    pageDescription:
      "Supervise Quill, a bold AI business analyst. Read its plans, check the numbers, and stop the bad reports before they go out.",
  },
];
...
const LIVE_IDS: readonly string[] = ["help-desk", "cybersecurity", "cloud-network", "full-stack", "business-analyst"] satisfies LivePathwayId[];
