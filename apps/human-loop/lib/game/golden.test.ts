...
function capture() {
  ...
  const cards = Object.fromEntries(HAND_ORDER.filter((id) => id !== ("policy-look-first" as CardId) && id !== ("policy-change-window" as CardId) && id !== ("policy-code-review" as CardId)).map((id) => [id, H.card(id)]));
