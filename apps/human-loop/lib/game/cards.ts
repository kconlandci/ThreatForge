...
export const CARDS: Record<CardId, CardDef> = {
  ...
  "policy-change-window": {
    ...
    name: "Policy: Change Window",
    cost: 1,
    kind: "power",
    target: "none",
    text: "Network and cloud plans get auto-inspected.",
    short: "Auto-inspects network & cloud.",
    flavor: "Root access is not a change window.",
    exhaust: true,
    icon: "ScrollText",
    autoInspect: ["network", "cloud"],
    alreadyOn: "The Change Window policy is already on.",
    policyOn: {
      title: "Policy: Change Window is on",
      text: "From now on, network and cloud plans get inspected automatically.",
      log: "Policy: Change Window is on. Network and cloud plans get inspected automatically.",
    },
  },
  "policy-code-review": {
    id: "policy-code-review",
    name: "Policy: Code Review",
    cost: 1,
    kind: "power",
    target: "none",
    text: "Code plans get auto-inspected.",
    short: "Auto-inspects code plans.",
    flavor: "Piper's SHIP IT key is not a review.",
    exhaust: true,
    icon: "ScrollText",
    autoInspect: ["code"],
    alreadyOn: "The Code Review policy is already on.",
    policyOn: {
      title: "Policy: Code Review is on",
      text: "From now on, code plans get inspected automatically: merges, releases, flags and packages.",
      log: "Policy: Code Review is on. Code plans get inspected automatically.",
    },
  },
  "policy-source-check": {
    id: "policy-source-check",
    name: "Policy: Source Check",
    cost: 1,
    kind: "power",
    target: "none",
    text: "Report plans get auto-inspected.",
    short: "Auto-inspects report plans.",
    flavor: "Quill's bold font is not a source.",
    exhaust: true,
    icon: "ScrollText",
    autoInspect: ["report"],
    alreadyOn: "The Source Check policy is already on.",
    policyOn: {
      title: "Policy: Source Check is on",
      text: "From now on, report plans get inspected automatically: charts, dashboards, decks, requirements and sharing.",
      log: "Policy: Source Check is on. Report plans get inspected automatically.",
    },
  },
  coffee: {
    id: "coffee",
